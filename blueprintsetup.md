...
- MotionSource 이름을 SteamVR Tracker Role과 맞춘다
  - 기본값: Waist, LeftKnee, RightKnee, LeftFoot, RightFoot
...
| VTC/Settings | MountOffset_LeftFoot_X/Y/Z | float | Left Foot 장착 오프셋 |
| VTC/Settings | MountOffset_RightFoot_X/Y/Z | float | Right Foot 장착 오프셋 |
...
2. SteamVR → Settings → Controllers → Manage Trackers
   - 5개 Tracker에 Role 할당: Waist, LeftKnee, RightKnee, LeftFoot, RightFoot
