...
//
// [BP 연결 필수 위젯 이름]
//   Txt_State        TextBlock — 현재 세션 상태 (Idle / Calibrating / Testing /
//   Reviewing) Txt_Prompt       TextBlock — 키 입력 안내 메시지 ("Press 1 to
//   Calibrate" 등) Txt_SubjectInfo  TextBlock — 피실험자 ID + 키 정보
