...
UCLASS(BlueprintType, Blueprintable, meta=(DisplayName="VKC Reference Point"))
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "VKC|Reference Point")
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "VKC|Reference Point")
